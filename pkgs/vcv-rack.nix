...
let
  ...
  vcv-rtaudio = stdenv.mkDerivation {
    ...
    src = fetchFromGitHub {
      owner = "VCVRack";
      repo = "rtaudio";
      rev = "22d64cdcb151e388791caceee8aa0011a6aa46e0";
...
stdenv.mkDerivation (finalAttrs: {
  ...
  ++ lib.optionals stdenv.hostPlatform.isLinux [
    # PR https://github.com/NixOS/nixpkgs/pull/526617
    # Remove this custom package and revert to nixpkgs vcv-rack once merged.
    (fetchpatch {
  ...
  prePatch = ''
    ...
    chmod -R +rw plugins/Fundamental
